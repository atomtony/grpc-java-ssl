package io.grpc.examples.conscrypt;
...
public class HelloWorldClientTls {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HelloWorldClientTls client = new HelloWorldClientTls("localhost", 8091, buildSslContext("/tmp/sslcert/ca.crt", "/tmp/sslcert/client.crt", "/tmp/sslcert/client.pem"));
